[@wharfkit/session - v1.0.0](/docs/testREADME.md) / VarInt
...
- [constructor](/docs/testclasses/VarInt.md#constructor)

### Properties

- [value](/docs/testclasses/VarInt.md#value)
- [abiName](/docs/testclasses/VarInt.md#abiname)
- [byteWidth](/docs/testclasses/VarInt.md#bytewidth)
- [isSigned](/docs/testclasses/VarInt.md#issigned)

### Accessors

- [byteArray](/docs/testclasses/VarInt.md#bytearray)
- [max](/docs/testclasses/VarInt.md#max)
- [min](/docs/testclasses/VarInt.md#min)

### Methods

- [[toPrimitive]](/docs/testclasses/VarInt.md#[toprimitive])
- [add](/docs/testclasses/VarInt.md#add)
- [adding](/docs/testclasses/VarInt.md#adding)
- [cast](/docs/testclasses/VarInt.md#cast)
- [divide](/docs/testclasses/VarInt.md#divide)
- [dividing](/docs/testclasses/VarInt.md#dividing)
- [equals](/docs/testclasses/VarInt.md#equals)
- [multiply](/docs/testclasses/VarInt.md#multiply)
- [multiplying](/docs/testclasses/VarInt.md#multiplying)
- [subtract](/docs/testclasses/VarInt.md#subtract)
- [subtracting](/docs/testclasses/VarInt.md#subtracting)
- [toABI](/docs/testclasses/VarInt.md#toabi)
- [toJSON](/docs/testclasses/VarInt.md#tojson)
- [toNumber](/docs/testclasses/VarInt.md#tonumber)
- [toString](/docs/testclasses/VarInt.md#tostring)
- [abiDefault](/docs/testclasses/VarInt.md#abidefault)
- [add](/docs/testclasses/VarInt.md#add-1)
- [div](/docs/testclasses/VarInt.md#div)
- [divCeil](/docs/testclasses/VarInt.md#divceil)
- [divRound](/docs/testclasses/VarInt.md#divround)
- [from](/docs/testclasses/VarInt.md#from)
- [fromABI](/docs/testclasses/VarInt.md#fromabi)
- [mul](/docs/testclasses/VarInt.md#mul)
- [random](/docs/testclasses/VarInt.md#random)
- [sub](/docs/testclasses/VarInt.md#sub)
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:670
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:671
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:672
...
▸ **adding**(`num`): [`VarInt`](/docs/testclasses/VarInt.md)
...
▸ **dividing**(`by`, `behavior?`): [`VarInt`](/docs/testclasses/VarInt.md)
...
▸ **multiplying**(`by`): [`VarInt`](/docs/testclasses/VarInt.md)
...
▸ **subtracting**(`num`): [`VarInt`](/docs/testclasses/VarInt.md)
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:674
...
▸ `Static` **fromABI**(`decoder`): [`VarInt`](/docs/testclasses/VarInt.md)
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:673
