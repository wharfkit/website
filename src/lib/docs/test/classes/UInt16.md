[@wharfkit/session - v1.0.0](/docs/testREADME.md) / UInt16
...
- [constructor](/docs/testclasses/UInt16.md#constructor)

### Properties

- [value](/docs/testclasses/UInt16.md#value)
- [abiName](/docs/testclasses/UInt16.md#abiname)
- [byteWidth](/docs/testclasses/UInt16.md#bytewidth)
- [isSigned](/docs/testclasses/UInt16.md#issigned)

### Accessors

- [byteArray](/docs/testclasses/UInt16.md#bytearray)
- [max](/docs/testclasses/UInt16.md#max)
- [min](/docs/testclasses/UInt16.md#min)

### Methods

- [[toPrimitive]](/docs/testclasses/UInt16.md#[toprimitive])
- [add](/docs/testclasses/UInt16.md#add)
- [adding](/docs/testclasses/UInt16.md#adding)
- [cast](/docs/testclasses/UInt16.md#cast)
- [divide](/docs/testclasses/UInt16.md#divide)
- [dividing](/docs/testclasses/UInt16.md#dividing)
- [equals](/docs/testclasses/UInt16.md#equals)
- [multiply](/docs/testclasses/UInt16.md#multiply)
- [multiplying](/docs/testclasses/UInt16.md#multiplying)
- [subtract](/docs/testclasses/UInt16.md#subtract)
- [subtracting](/docs/testclasses/UInt16.md#subtracting)
- [toABI](/docs/testclasses/UInt16.md#toabi)
- [toJSON](/docs/testclasses/UInt16.md#tojson)
- [toNumber](/docs/testclasses/UInt16.md#tonumber)
- [toString](/docs/testclasses/UInt16.md#tostring)
- [abiDefault](/docs/testclasses/UInt16.md#abidefault)
- [add](/docs/testclasses/UInt16.md#add-1)
- [div](/docs/testclasses/UInt16.md#div)
- [divCeil](/docs/testclasses/UInt16.md#divceil)
- [divRound](/docs/testclasses/UInt16.md#divround)
- [from](/docs/testclasses/UInt16.md#from)
- [fromABI](/docs/testclasses/UInt16.md#fromabi)
- [mul](/docs/testclasses/UInt16.md#mul)
- [random](/docs/testclasses/UInt16.md#random)
- [sub](/docs/testclasses/UInt16.md#sub)
...
▸ **adding**(`num`): [`UInt16`](/docs/testclasses/UInt16.md)
...
▸ **dividing**(`by`, `behavior?`): [`UInt16`](/docs/testclasses/UInt16.md)
...
▸ **multiplying**(`by`): [`UInt16`](/docs/testclasses/UInt16.md)
...
▸ **subtracting**(`num`): [`UInt16`](/docs/testclasses/UInt16.md)
