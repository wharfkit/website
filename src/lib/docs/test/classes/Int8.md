[@wharfkit/session - v1.0.0](/docs/testREADME.md) / Int8
...
- [constructor](/docs/testclasses/Int8.md#constructor)

### Properties

- [value](/docs/testclasses/Int8.md#value)
- [abiName](/docs/testclasses/Int8.md#abiname)
- [byteWidth](/docs/testclasses/Int8.md#bytewidth)
- [isSigned](/docs/testclasses/Int8.md#issigned)

### Accessors

- [byteArray](/docs/testclasses/Int8.md#bytearray)
- [max](/docs/testclasses/Int8.md#max)
- [min](/docs/testclasses/Int8.md#min)

### Methods

- [[toPrimitive]](/docs/testclasses/Int8.md#[toprimitive])
- [add](/docs/testclasses/Int8.md#add)
- [adding](/docs/testclasses/Int8.md#adding)
- [cast](/docs/testclasses/Int8.md#cast)
- [divide](/docs/testclasses/Int8.md#divide)
- [dividing](/docs/testclasses/Int8.md#dividing)
- [equals](/docs/testclasses/Int8.md#equals)
- [multiply](/docs/testclasses/Int8.md#multiply)
- [multiplying](/docs/testclasses/Int8.md#multiplying)
- [subtract](/docs/testclasses/Int8.md#subtract)
- [subtracting](/docs/testclasses/Int8.md#subtracting)
- [toABI](/docs/testclasses/Int8.md#toabi)
- [toJSON](/docs/testclasses/Int8.md#tojson)
- [toNumber](/docs/testclasses/Int8.md#tonumber)
- [toString](/docs/testclasses/Int8.md#tostring)
- [abiDefault](/docs/testclasses/Int8.md#abidefault)
- [add](/docs/testclasses/Int8.md#add-1)
- [div](/docs/testclasses/Int8.md#div)
- [divCeil](/docs/testclasses/Int8.md#divceil)
- [divRound](/docs/testclasses/Int8.md#divround)
- [from](/docs/testclasses/Int8.md#from)
- [fromABI](/docs/testclasses/Int8.md#fromabi)
- [mul](/docs/testclasses/Int8.md#mul)
- [random](/docs/testclasses/Int8.md#random)
- [sub](/docs/testclasses/Int8.md#sub)
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:610
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:611
...
node_modules/@wharfkit/antelope/lib/antelope.d.ts:612
...
▸ **adding**(`num`): [`Int8`](/docs/testclasses/Int8.md)
...
▸ **dividing**(`by`, `behavior?`): [`Int8`](/docs/testclasses/Int8.md)
...
▸ **multiplying**(`by`): [`Int8`](/docs/testclasses/Int8.md)
...
▸ **subtracting**(`num`): [`Int8`](/docs/testclasses/Int8.md)
