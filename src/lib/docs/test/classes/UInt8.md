[@wharfkit/session - v1.0.0](/docs/testREADME.md) / UInt8
...
- [constructor](/docs/testclasses/UInt8.md#constructor)

### Properties

- [value](/docs/testclasses/UInt8.md#value)
- [abiName](/docs/testclasses/UInt8.md#abiname)
- [byteWidth](/docs/testclasses/UInt8.md#bytewidth)
- [isSigned](/docs/testclasses/UInt8.md#issigned)

### Accessors

- [byteArray](/docs/testclasses/UInt8.md#bytearray)
- [max](/docs/testclasses/UInt8.md#max)
- [min](/docs/testclasses/UInt8.md#min)

### Methods

- [[toPrimitive]](/docs/testclasses/UInt8.md#[toprimitive])
- [add](/docs/testclasses/UInt8.md#add)
- [adding](/docs/testclasses/UInt8.md#adding)
- [cast](/docs/testclasses/UInt8.md#cast)
- [divide](/docs/testclasses/UInt8.md#divide)
- [dividing](/docs/testclasses/UInt8.md#dividing)
- [equals](/docs/testclasses/UInt8.md#equals)
- [multiply](/docs/testclasses/UInt8.md#multiply)
- [multiplying](/docs/testclasses/UInt8.md#multiplying)
- [subtract](/docs/testclasses/UInt8.md#subtract)
- [subtracting](/docs/testclasses/UInt8.md#subtracting)
- [toABI](/docs/testclasses/UInt8.md#toabi)
- [toJSON](/docs/testclasses/UInt8.md#tojson)
- [toNumber](/docs/testclasses/UInt8.md#tonumber)
- [toString](/docs/testclasses/UInt8.md#tostring)
- [abiDefault](/docs/testclasses/UInt8.md#abidefault)
- [add](/docs/testclasses/UInt8.md#add-1)
- [div](/docs/testclasses/UInt8.md#div)
- [divCeil](/docs/testclasses/UInt8.md#divceil)
- [divRound](/docs/testclasses/UInt8.md#divround)
- [from](/docs/testclasses/UInt8.md#from)
- [fromABI](/docs/testclasses/UInt8.md#fromabi)
- [mul](/docs/testclasses/UInt8.md#mul)
- [random](/docs/testclasses/UInt8.md#random)
- [sub](/docs/testclasses/UInt8.md#sub)
...
▸ **adding**(`num`): [`UInt8`](/docs/testclasses/UInt8.md)
...
▸ **dividing**(`by`, `behavior?`): [`UInt8`](/docs/testclasses/UInt8.md)
...
▸ **multiplying**(`by`): [`UInt8`](/docs/testclasses/UInt8.md)
...
▸ **subtracting**(`num`): [`UInt8`](/docs/testclasses/UInt8.md)
