    ...
    <div class="content | flow">
      <section id="assets">
        ...
        <p>
          ...
          for you here: the logo, colors, font, and background images. If you would like to go
          further in your usage of the Wharf brand, please download the Brand Guidelines PDF for
