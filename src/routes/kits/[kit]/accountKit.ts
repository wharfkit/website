...
const kit: KitPage = {
  ...
  //     link: {
  //       href: 'https://github.com/wharfkit',
  ...
  //     description: 'UX can make or break an app. That’s why the Session Kit provides a Wharf-themed UI Renderer that was created by a professional UX designer, with the primary goal of creating a pleasant and intuitive experience for your users. \n\nThe UI Renderer comes with out-of-the-box functionality that covers a range of common user scenarios, and can be paired with the Session Kit’s Localization Engine to support multiple languages.',
  //     link: {
  //       href: 'https://github.com/wharfkit',
  //       text: 'Go to Wharf Github',
  //     }
  ...
  //   //   description: 'The Session Kit provides a simple interface for creating a session. This session can be used to perform actions on-chain, or to sign transactions.',
  //   // },
  //   // {
  //   //   title: 'Create a session',
  //   //   description: 'The Session Kit provides a simple interface for creating a session. This session can be used to perform actions on-chain, or to sign transactions.',
